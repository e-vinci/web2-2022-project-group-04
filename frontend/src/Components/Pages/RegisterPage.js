...
const RegisterFormPage = () => {
  ...
  //buttonDisplayFormDev.addEventListener('click', ()=>{renderRegisterFormDevPage()});
  buttonDisplayFormDev.addEventListener('click', ()=>{console.log("");});
  buttonDisplayFormCompanie.addEventListener('click', ()=>{renderRegisterFormCompaniesPage()});
};
